...
namespace Sinav
{
    ...
    public partial class SinavUserControl2 : UserControl
    {
        ...
        private void SinavUserControl2_Load(object sender, EventArgs e)
        {
